...
public class CreateReactome2BioSystems {
	...
	public static void execute(String host, String database, String username, String password, int port) throws IOException {
		...
		Runtime.getRuntime().exec("mv BioSystems/ReactomeToBioSystems.zip .");
