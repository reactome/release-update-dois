...
class GoTermInstanceModifier
{
	 ...
	 */
	public void createNewGOTerm(Map<String, Map<String, Object>> goTerms, Map<String,List<String>> goToEcNumbers, String currentGOID, String currentCategory, GKInstance goRefDB)
	{
